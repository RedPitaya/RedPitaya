...
$(TARGET): old_apps $(BOOT) $(TESTBOOT) $(UBOOT_SCRIPT) $(DEVICETREE) $(LINUX) $(URAMDISK) $(NGINX) $(IDGEN) $(MONITOR) $(GENERATE) $(ACQUIRE) $(CALIB) $(DISCOVERY) $(ECOSYSTEM) $(SCPI_SERVER) $(LIBRP) $(LIBRPAPP) $(GDBSERVER) $(OLD_APPS) $(APP_SPECTRUM) sdk rp_communication
	mkdir $(TARGET)
	cp $(BOOT)             $(TARGET)
	cp $(TESTBOOT)         $(TARGET)
