...
(function (e) {
  ...
  e.widget.extend = function (t) {
    ...
    n[o].hasOwnProperty(i) && void 0 !== s && (t[i] = e.isPlainObject(s) ? e.isPlainObject(t[i]) ? e.widget.extend({
  ...
  e.widget.bridge = function (t, i) {
    ...
    e.fn[t] = function (n) {
      ...
      })  : (r.length && (n = e.widget.extend.apply(null, [
        n
  ...
  e.Widget.prototype = {
    ...
    option: function (t, i) {
      ...
      if ('string' == typeof t) if (o = {
        ...
        for (a = o[t] = e.widget.extend({
        }, this.options[t]), n = 0; s.length - 1 > n; n++) a[s[n]] = a[s[n]] || {
        },
        a = a[s[n]];
  ...
  e.widget('ui.draggable', e.ui.mouse, {
    ...
    _createHelper: function (t) {
      ...
      a = s ? e(i.helper.apply(this.element[0], [
        t
    ...
    _setContainment: function () {
      ...
      a.containment ? 'window' === a.containment ? (this.containment = [
        ...
        e(window).scrollTop() + (e(window).height() || n.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top
      ], void 0)  : 'document' === a.containment ? (this.containment = [
        0,
        0,
        e(n).width() - this.helperProportions.width - this.margins.left,
        (e(n).height() || n.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top
      ], void 0)  : a.containment.constructor === Array ? (this.containment = a.containment, void 0)  : ('parent' === a.containment && (a.containment = this.helper[0].parentNode), i = e(a.containment), s = i[0], s && (t = /(scroll|auto)/.test(i.css('overflow')), this.containment = [
  ...
  e.ui.plugin.add('draggable', 'scroll', {
    ...
    drag: function (t, i, s) {
      ...
      r = s.document[0];
      o !== r && 'HTML' !== o.tagName ? (a.axis && 'x' === a.axis || (s.overflowOffset.top + o.offsetHeight - t.pageY < a.scrollSensitivity ? o.scrollTop = n = o.scrollTop + a.scrollSpeed : t.pageY - s.overflowOffset.top < a.scrollSensitivity && (o.scrollTop = n = o.scrollTop - a.scrollSpeed)), a.axis && 'y' === a.axis || (s.overflowOffset.left + o.offsetWidth - t.pageX < a.scrollSensitivity ? o.scrollLeft = n = o.scrollLeft + a.scrollSpeed : t.pageX - s.overflowOffset.left < a.scrollSensitivity && (o.scrollLeft = n = o.scrollLeft - a.scrollSpeed)))  : (a.axis && 'x' === a.axis || (t.pageY - e(r).scrollTop() < a.scrollSensitivity ? n = e(r).scrollTop(e(r).scrollTop() - a.scrollSpeed)  : e(window).height() - (t.pageY - e(r).scrollTop()) < a.scrollSensitivity && (n = e(r).scrollTop(e(r).scrollTop() + a.scrollSpeed))), a.axis && 'y' === a.axis || (t.pageX - e(r).scrollLeft() < a.scrollSensitivity ? n = e(r).scrollLeft(e(r).scrollLeft() - a.scrollSpeed)  : e(window).width() - (t.pageX - e(r).scrollLeft()) < a.scrollSensitivity && (n = e(r).scrollLeft(e(r).scrollLeft() + a.scrollSpeed)))),
  ...
  e.ui.plugin.add('draggable', 'snap', {
    ...
    drag: function (t, i, s) {
      ...
      h - m > v || g > l + m || u - m > b || y > d + m || !e.contains(s.snapElements[c].item.ownerDocument, s.snapElements[c].item) ? (s.snapElements[c].snapping && s.options.snap.release && s.options.snap.release.call(s.element, t, e.extend(s._uiHash(), {
        ...
        top: 0,
        left: l
      }).left)), p = a || n || o || r, 'outer' !== f.snapMode && (a = m >= Math.abs(u - y), n = m >= Math.abs(d - b), o = m >= Math.abs(h - g), r = m >= Math.abs(l - v), a && (i.position.top = s._convertPositionTo('relative', {
        top: u,
        left: 0
      }).top), n && (i.position.top = s._convertPositionTo('relative', {
      ...
      }).left)), !s.snapElements[c].snapping && (a || n || o || r || p) && s.options.snap.snap && s.options.snap.snap.call(s.element, t, e.extend(s._uiHash(), {
        snapItem: s.snapElements[c].item
