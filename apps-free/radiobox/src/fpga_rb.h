...
enum {
    ...
    FPGA_RB_TX_CAR_OSC_INC_LO      = 0x00020,
    FPGA_RB_TX_CAR_OSC_INC_HI      = 0x00024,
    FPGA_RB_TX_CAR_OSC_OFS_LO      = 0x00028,
    FPGA_RB_TX_CAR_OSC_OFS_HI      = 0x0002C,
    FPGA_RB_TX_CAR_OSC_MIX_GAIN    = 0x00030,
    FPGA_RB_TX_CAR_OSC_MIX_OFS_LO  = 0x00038,
    FPGA_RB_TX_CAR_OSC_MIX_OFS_HI  = 0x0003C,
    FPGA_RB_TX_MOD_OSC_INC_LO      = 0x00040,
    FPGA_RB_TX_MOD_OSC_INC_HI      = 0x00044,
    FPGA_RB_TX_MOD_OSC_OFS_LO      = 0x00048,
    FPGA_RB_TX_MOD_OSC_OFS_HI      = 0x0004C,
    FPGA_RB_TX_MOD_OSC_MIX_GAIN    = 0x00050,
    FPGA_RB_TX_MOD_OSC_MIX_OFS_LO  = 0x00058,
    FPGA_RB_TX_MOD_OSC_MIX_OFS_HI  = 0x0005C,
    FPGA_RB_TX_MUXIN_SRC           = 0x00060,
    FPGA_RB_TX_MUXIN_GAIN          = 0x00064
} FPGA_RB_REG_ENUMS;
...
typedef struct fpga_rb_reg_mem_s {
     ...
     * bit h13..h0F: n/a
     *
     * bit h14: TX_AMP_RF_Q_EN - '1' enables the TX_CAR_QMIX Q path for the SSB modulation
     *
     * bit h1F..h15: n/a
     *
     */
     ...
     *   value = h08  TX_MOD_QMIX_I output at stage 1.
     *   value = h09  TX_MOD_QMIX_Q output at stage 1.
     *   value = h0A  TX_MOD_QMIX_I output at stage 2.
     *   value = h0B  TX_MOD_QMIX_Q output at stage 2.
     *   value = h0C  TX_MOD_QMIX_I output at stage 3.
     *   value = h0D  TX_MOD_QMIX_Q output at stage 3.
     ...
     *   value = h14  interpolator TX_CAR_CIC I output 41.664 MHz output.
     *   value = h15  interpolator TX_CAR_CIC Q output 41.664 MHz output.
     *   value = h18  TX_CAR_QMIX_I output.
     *   value = h19  TX_CAR_QMIX_Q output.
 ...
 * @param[in]  modsrc           0==(none), 1==RF Input 1, 2==RF Input 2, 4==EXP AI0, 5==EXP AI1, 6==EXP AI2, 7==EXP AI3, 15==TX_MOD_OSC
 * @param[in]  modtyp           when modsrc == TX_MOD_OSC: 0==USB, 1==LSB, 2==AM, 3==FM, 4==PM - else ignored.
 ...
 */
void fpga_rb_set_ctrl(int rb_run, int modsrc, int modtyp, int src_con_pnt, double tx_car_osc_qrg, double tx_mod_osc_qrg, double tx_amp_rf_gain, double tx_mod_osc_mag, double tx_muxin_gain);
