...
class CCustomSignal<OutputPacket> : public CParameter<OutputPacket, std::vector<OutputPacket>> {
   public:
    CCustomSignal(std::string _name, int _size, OutputPacket _def_value)
        : CParameter<OutputPacket, std::vector<OutputPacket>>(CParameter<OutputPacket, std::vector<OutputPacket>>::SIGNAL, _name, CBaseParameter::RO,
                                                              std::vector<OutputPacket>(_size, _def_value)),
          m_Dirty(true) {}

    CCustomSignal(std::string _name, CBaseParameter::AccessMode _access_mode, int _size, OutputPacket _def_value)
        : CParameter<OutputPacket, std::vector<OutputPacket>>(CParameter<OutputPacket, std::vector<OutputPacket>>::SIGNAL, _name, _access_mode,
                                                              std::vector<OutputPacket>(_size, _def_value)),
          m_Dirty(true) {}
    ...
    const OutputPacket& operator[](int _index) const { return this->m_Value.value.at(_index); }
    ...
    size_t GetSizeInBytes() { return GetSize() * sizeof(OutputPacket); }
...
class CDecodedSignal : public CCustomSignal<OutputPacket> {
   public:
    CDecodedSignal(std::string _name, int _size, OutputPacket _def_value) : CCustomSignal(_name, _size, _def_value){};

    CDecodedSignal(std::string _name, CBaseParameter::AccessMode _access_mode, int _size, OutputPacket _def_value) : CCustomSignal(_name, _access_mode, _size, _def_value){};
