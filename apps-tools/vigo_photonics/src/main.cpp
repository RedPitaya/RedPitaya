...
void updateParametersByConfig() {
    ...
    setHomeSettingsPath("/.config/redpitaya/apps/vigo_photonics_" + std::to_string((int)getModel()) + "/");
...
int rp_app_init(void) {
    ...
    createDirTree("/tmp/vigo_photonics");
...
int rp_app_exit(void) {
    fprintf(stderr, "Unloading VIGO photonics version %s-%s.\n", VERSION_STR, REVISION_STR);
    stopPtccService();
