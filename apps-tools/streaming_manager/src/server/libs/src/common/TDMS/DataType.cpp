...
auto DataType::InitRaw(TDMSType dataType,uint64_t count,void *rawData) -> void{
    m_dataType = dataType;
...
TDMS::DataType::Raw::~Raw() noexcept(false){
    if (data != nullptr){
        switch (dataType)
        {
            ...
            case TDMSType::Integer8:  delete[] reinterpret_cast<int8_t*>(data); break;
            case TDMSType::Integer16: delete[] reinterpret_cast<int16_t*>(data); break;
            case TDMSType::Integer32: delete[] reinterpret_cast<int32_t*>(data); break;
            case TDMSType::Integer64: delete[] reinterpret_cast<int64_t*>(data); break;
            case TDMSType::Boolean:
            case TDMSType::UnsignedInteger8: delete[] reinterpret_cast<uint8_t*>(data); break;
            case TDMSType::UnsignedInteger16: delete[] reinterpret_cast<uint16_t*>(data); break;
            case TDMSType::UnsignedInteger32: delete[] reinterpret_cast<uint32_t*>(data); break;
            case TDMSType::TimeStamp:
            case TDMSType::UnsignedInteger64: delete[] reinterpret_cast<uint64_t*>(data); break;
            case TDMSType::SingleFloat:
            case TDMSType::SingleFloatWithUnit: delete[] reinterpret_cast<float*>(data); break;
            case TDMSType::DoubleFloat:
            case TDMSType::DoubleFloatWithUnit:delete[] reinterpret_cast<double*>(data); break;
            case TDMSType::String:delete[] reinterpret_cast<char*>(data); break;
            default: {
                std::string message = "Cannot determine of data type ";
                throw std::runtime_error(message.c_str());
            }
