...
(function(Desktop, $) {
    ...
    var default_applications = [
        ...
        { id: "activelearning", name: "Active Learning", description: "Active Learning with Red Pitaya", url: "http:http://red-pitaya-active-learning.readthedocs.io/en/latest/", image: "../assets/images/active-learning.png", check_online: false, licensable: false, callback: undefined, type: 'run' },
