...
scpi_result_t RP_GenChannel1FrequencyQ(scpi_t * context);
scpi_result_t RP_GenChannel2FrequencyQ(scpi_t * context);
scpi_result_t RP_GenChannel1WaveForm(scpi_t * context);
scpi_result_t RP_GenChannel2WaveForm(scpi_t * context);
scpi_result_t RP_GenChannel1WaveFormQ(scpi_t * context);
scpi_result_t RP_GenChannel2WaveFormQ(scpi_t * context);
