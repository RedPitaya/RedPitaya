...
const scpi_choice_def_t scpi_lcr_shunt[] = {
    {"S10", RP_LCR_S_10},
    {"S100", RP_LCR_S_100},
    {"S1k", RP_LCR_S_1k},
    {"S10k", RP_LCR_S_10k},
...
const scpi_choice_def_t scpi_lcr_shunt_mode[] = {
    {"LCR_EXT", RP_LCR_S_EXTENSION},
    {"CUSTOM", RP_LCR_S_CUSTOM},
    SCPI_CHOICE_LIST_END
};

const scpi_choice_def_t scpi_lcr_series_mode[] = {
    {"SERIES", 1},
    {"PARALLEL", 0},
    SCPI_CHOICE_LIST_END
};
