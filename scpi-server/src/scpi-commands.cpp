...
static const scpi_command_t scpi_commands[] = {
    ...
    SCPI_CMD("ACQ:UNLOCK", RP_AcqUnlock),
    SCPI_CMD("ACQ:UNLOCK:CH#", RP_AcqUnlockCh),
    ...
    SCPI_CMD("ACQ:TRig:INT#:STAT?", RP_AcqInterrupTriggerQ),
    SCPI_CMD("ACQ:TRig:INT#:STAT:CH#?", RP_AcqInterrupTriggerChQ),
    ...
    SCPI_CMD("ACQ:TRig:INT:ENABLE", RP_AcqTriggerIntEnable),
    SCPI_CMD("ACQ:TRig:INT:ENABLE?", RP_AcqTriggerIntEnableQ),
    SCPI_CMD("ACQ:TRig:INT:ENABLE:CH#", RP_AcqTriggerIntEnableCh),
    SCPI_CMD("ACQ:TRig:INT:ENABLE:CH#?", RP_AcqTriggerIntEnableChQ),
    SCPI_CMD("ACQ:TRig:INT#:FILL?", RP_AcqInterrupFillQ),
    ...
    SCPI_CMD("ACQ:SOUR#:OFFS", RP_AcqOffset),
    SCPI_CMD("ACQ:SOUR#:OFFS?", RP_AcqOffsetQ),
