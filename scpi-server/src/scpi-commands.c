...
static const scpi_command_t scpi_commands[] = {
        ...
        {.pattern = "ACQ:SOUR1:GAIN", .callback     = RP_AcqChannel1Gain,},
        {.pattern = "ACQ:SOUR2:GAIN", .callback     = RP_AcqChannel2Gain,},
        {.pattern = "ACQ:SOUR1:GAIN?", .callback    = RP_AcqChannel1GainQ,},
        {.pattern = "ACQ:SOUR2:GAIN?", .callback    = RP_AcqChannel2GainQ,},
        ...
        {.pattern = "ACQ:SOUR1:DATA:STA:END?", .callback    = RP_AcqChannel1DataPosQ,},
        {.pattern = "ACQ:SOUR2:DATA:STA:END?", .callback    = RP_AcqChannel2DataPosQ,},
        {.pattern = "ACQ:SOUR1:DATA:STA:N?", .callback      = RP_AcqChannel1DataQ,},
        {.pattern = "ACQ:SOUR2:DATA:STA:N?", .callback      = RP_AcqChannel2DataQ,},
        {.pattern = "ACQ:SOUR1:DATA?", .callback            = RP_AcqChannel1OldestDataAllQ,},
        {.pattern = "ACQ:SOUR2:DATA?", .callback            = RP_AcqChannel2OldestDataAllQ,},
        {.pattern = "ACQ:SOUR1:DATA:OLD:N?", .callback      = RP_AcqChannel1OldestDataQ,},
        ...
        {.pattern = "OUTPUT1:STATE", .callback          = RP_GenChannel1State,},
        {.pattern = "OUTPUT2:STATE", .callback          = RP_GenChannel2State,},
        {.pattern = "OUTPUT1:STATE?", .callback         = RP_GenChannel1StateQ,},
        {.pattern = "OUTPUT2:STATE?", .callback         = RP_GenChannel2StateQ,},
        {.pattern = "SOUR1:FREQ:FIX", .callback         = RP_GenChannel1Frequency,},
        {.pattern = "SOUR2:FREQ:FIX", .callback         = RP_GenChannel2Frequency,},
        {.pattern = "SOUR1:FREQ:FIX?", .callback        = RP_GenChannel1FrequencyQ,},
        {.pattern = "SOUR2:FREQ:FIX?", .callback        = RP_GenChannel2FrequencyQ,},
