...
const scpi_choice_def_t scpi_TRIG_O_mode[] = {{"ADC", 0}, {"DAC", 1}, SCPI_CHOICE_LIST_END};

const scpi_choice_def_t scpi_DAISY_state[] = {{"OFF", 0}, {"ON", 1}, SCPI_CHOICE_LIST_END};

const scpi_choice_def_t scpi_PLL_state[] = {{"OFF", 0}, {"ON", 1}, SCPI_CHOICE_LIST_END};
...
scpi_result_t RP_SourceTrigOutputQ(scpi_t* context) {
    const char* _name = nullptr;
    rp_outTiggerMode_t value = OUT_TR_ADC;
