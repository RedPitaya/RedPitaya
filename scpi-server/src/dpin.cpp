...
const scpi_choice_def_t scpi_RpDpin[] = {{"LED0", 0},    {"LED1", 1},    {"LED2", 2},     {"LED3", 3},    {"LED4", 4},    {"LED5", 5},     {"LED6", 6},         {"LED7", 7},
                                         {"DIO0_P", 8},  {"DIO1_P", 9},  {"DIO2_P", 10},  {"DIO3_P", 11}, {"DIO4_P", 12}, {"DIO5_P", 13},  {"DIO6_P", 14},      {"DIO7_P", 15},
                                         {"DIO8_P", 16}, {"DIO9_P", 17}, {"DIO10_P", 18}, {"DIO0_N", 19}, {"DIO1_N", 20}, {"DIO2_N", 21},  {"DIO3_N", 22},      {"DIO4_N", 23},
                                         {"DIO5_N", 24}, {"DIO6_N", 25}, {"DIO7_N", 26},  {"DIO8_N", 27}, {"DIO9_N", 28}, {"DIO10_N", 29}, SCPI_CHOICE_LIST_END};

const scpi_choice_def_t scpi_RpDir[] = {{"IN", 0}, {"OUT", 1}, SCPI_CHOICE_LIST_END};
...
scpi_result_t RP_DigitalPinDirection(scpi_t* context) {
    int32_t dir_choice = 0, pin_choice = 0;
