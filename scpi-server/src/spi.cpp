...
const scpi_choice_def_t scpi_mode[] = {{"LISL", RP_SPI_MODE_LISL}, {"LIST", RP_SPI_MODE_LIST}, {"HISL", RP_SPI_MODE_HISL}, {"HIST", RP_SPI_MODE_HIST}, SCPI_CHOICE_LIST_END};
...
scpi_result_t RP_SPI_GetModeQ(scpi_t* context) {
    ...
    rp_spi_mode_t value = RP_SPI_MODE_LISL;
...
scpi_result_t RP_SPI_GetCSModeQ(scpi_t* context) {
    const char* _name = nullptr;
    rp_spi_cs_mode_t value = RP_SPI_CS_NORMAL;
