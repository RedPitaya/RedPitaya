...
void calib_SetToZero() {
    ...
    calib.fe_ch1_fs_g_lo = cmn_CalibFullScaleFromVoltage(20.0 * coff);
    calib.fe_ch1_fs_g_hi = cmn_CalibFullScaleFromVoltage(1.0  * coff);
    calib.fe_ch2_fs_g_lo = cmn_CalibFullScaleFromVoltage(20.0 * coff);
    calib.fe_ch2_fs_g_hi = cmn_CalibFullScaleFromVoltage(1    * coff);
}
