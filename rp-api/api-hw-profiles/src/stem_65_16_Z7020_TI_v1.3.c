...
profiles_t* getProfile_STEM_65_16_Z7020_TI_v1_3(){
    ...
    if (!initialized) {
        fast_adc_rate = stem_65_16_Z7020_TI_v1_3.fast_adc_rate;
        fast_dac_rate = stem_65_16_Z7020_TI_v1_3.fast_dac_rate;
        initialized = true;
    }

    int rate = hp_cmn_GetADCBaseRateFromConfig(stem_65_16_Z7020_TI_v1_3.boardModel);
    if (rate != 0){
        stem_65_16_Z7020_TI_v1_3.fast_adc_rate = rate;
    }else{
        stem_65_16_Z7020_TI_v1_3.fast_adc_rate = fast_adc_rate;
    }

    rate = hp_cmn_GetDACBaseRateFromConfig(stem_65_16_Z7020_TI_v1_3.boardModel);
    if (rate != 0){
        stem_65_16_Z7020_TI_v1_3.fast_dac_rate = rate;
    }else{
        stem_65_16_Z7020_TI_v1_3.fast_dac_rate = fast_dac_rate;
    }
