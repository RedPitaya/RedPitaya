...
profiles_t stem_125_14_v1_0 = {.boardModel = STEM_125_14_v1_0,
...
profiles_t* getProfile_STEM_125_14_v1_0() {
    profiles_t* profile = []() -> profiles_t* {
        uint32_t orig_adc = stem_125_14_v1_0.fast_adc_rate;
        uint32_t orig_dac = stem_125_14_v1_0.fast_dac_rate;
        uint32_t orig_spec = stem_125_14_v1_0.fast_adc_spectrum_resolution;
        uint32_t orig_adc_fp = stem_125_14_v1_0.fast_adc_low_pass_filter;
        uint32_t orig_dac_fp = stem_125_14_v1_0.fast_dac_low_pass_filter;
        uint32_t orig_gen_min_speed = stem_125_14_v1_0.gen_min_speed;
        uint32_t orig_gen_max_speed = stem_125_14_v1_0.gen_max_speed;

        applyRate(stem_125_14_v1_0.fast_adc_rate, orig_adc, ADC_BASE_RATE_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.fast_dac_rate, orig_dac, DAC_BASE_RATE_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.fast_adc_spectrum_resolution, orig_spec, SPEC_ADC_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.fast_adc_low_pass_filter, orig_adc_fp, ADC_LP_FILTER_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.fast_dac_low_pass_filter, orig_dac_fp, DAC_LP_FILTER_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.gen_min_speed, orig_gen_min_speed, GEN_MIN_RATE_PATH, stem_125_14_v1_0.boardModel);
        applyRate(stem_125_14_v1_0.gen_max_speed, orig_gen_max_speed, GEN_MAX_RATE_PATH, stem_125_14_v1_0.boardModel);
