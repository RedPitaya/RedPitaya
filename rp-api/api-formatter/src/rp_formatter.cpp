...
auto CFormatter::setChannelData(rp_channel_t _channel,void* _buffer,size_t _samplesCount,rp_bits_t _bits) -> void {
...
auto CFormatter::setChannel(rp_channel_t _channel,uint8_t* _buffer,size_t _samplesCount) -> void {
    setChannelData(_channel,_buffer,_samplesCount,RP_F_8_Bit);
}

auto CFormatter::setChannel(rp_channel_t _channel,uint16_t* _buffer,size_t _samplesCount) -> void {
    setChannelData(_channel,_buffer,_samplesCount,RP_F_16_Bit);
}

auto CFormatter::setChannel(rp_channel_t _channel,float* _buffer,size_t _samplesCount) -> void {
    setChannelData(_channel,_buffer,_samplesCount,RP_F_32_Bit);
}

auto CFormatter::setChannel(rp_channel_t _channel,double* _buffer,size_t _samplesCount) -> void {
    setChannelData(_channel,_buffer,_samplesCount,RP_F_64_Bit);
}
