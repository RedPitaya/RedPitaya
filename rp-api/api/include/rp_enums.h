...
typedef enum { RP_DC = 0, RP_AC = 1 } rp_acq_ac_dc_mode_t;
...
typedef enum {
    ...
    RP_TRIG_SRC_CHA_AE = 18,   //!< Trigger set to Channel A threshold any edge (positive or negative)
    RP_TRIG_SRC_CHB_AE = 20,   //!< Trigger set to Channel B threshold any edge (positive or negative)
    RP_TRIG_SRC_EXT_AE = 22,   //!< Trigger set to external trigger any edge (DIO0_P pin)
    RP_TRIG_SRC_AWG_AE = 24,   //!< Trigger set to arbitrary wave generator application any edge
    RP_TRIG_SRC_CHC_AE = 26,   //!< Trigger set to Channel C threshold any edge (positive or negative)
    RP_TRIG_SRC_CHD_AE = 28    //!< Trigger set to Channel D threshold any edge (positive or negative)
} rp_acq_trig_src_t;
