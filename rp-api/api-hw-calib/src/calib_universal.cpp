...
std::string getNameOfUniversalId(uint16_t id) {
    switch ((rp_calib_universal_id_t)id) {
        case UC_DAC_CH1_GAIN:
            return "DAC Ch1 Gain";
        case UC_DAC_CH1_OFFSET:
            return "DAC Ch1 Offset";
        case UC_DAC_CH2_GAIN:
            return "DAC Ch2 Gain";
        case UC_DAC_CH2_OFFSET:
            return "DAC Ch2 Offset";
        case UC_DAC_CH1_GAIN_X5:
            return "DAC Ch1 Gain x5";
        case UC_DAC_CH1_OFFSET_X5:
            return "DAC Ch1 Offset x5";
        case UC_DAC_CH2_GAIN_X5:
            return "DAC Ch2 Gain x5";
        case UC_DAC_CH2_OFFSET_X5:
            return "DAC Ch2 Offset x5";

        case UC_ADC_CH1_GAIN_1_1:
            return "ADC Ch1 Gain 1/1";
        case UC_ADC_CH1_OFFSET_1_1:
            return "ADC Ch1 Offset 1/1";
        case UC_ADC_CH2_GAIN_1_1:
            return "ADC Ch2 Gain 1/1";
        case UC_ADC_CH2_OFFSET_1_1:
            return "ADC Ch2 Offset 1/1";
        case UC_ADC_CH3_GAIN_1_1:
            return "ADC Ch3 Gain 1/1";
        case UC_ADC_CH3_OFFSET_1_1:
            return "ADC Ch3 Offset 1/1";
        case UC_ADC_CH4_GAIN_1_1:
            return "ADC Ch4 Gain 1/1";
        case UC_ADC_CH4_OFFSET_1_1:
            return "ADC Ch4 Offset 1/1";

        case UC_ADC_CH1_GAIN_1_20:
            return "ADC Ch1 Gain 1/20";
        case UC_ADC_CH1_OFFSET_1_20:
            return "ADC Ch1 Offset 1/20";
        case UC_ADC_CH2_GAIN_1_20:
            return "ADC Ch2 Gain 1/20";
        case UC_ADC_CH2_OFFSET_1_20:
            return "ADC Ch2 Offset 1/20";
        case UC_ADC_CH3_GAIN_1_20:
            return "ADC Ch3 Gain 1/20";
        case UC_ADC_CH3_OFFSET_1_20:
            return "ADC Ch3 Offset 1/20";
        case UC_ADC_CH4_GAIN_1_20:
            return "ADC Ch4 Gain 1/20";
        case UC_ADC_CH4_OFFSET_1_20:
            return "ADC Ch4 Offset 1/20";

        case UC_ADC_CH1_GAIN_1_1_AC:
            return "ADC Ch1 Gain 1/1 AC";
        case UC_ADC_CH1_OFFSET_1_1_AC:
            return "ADC Ch1 Offset 1/1 AC";
        case UC_ADC_CH2_GAIN_1_1_AC:
            return "ADC Ch2 Gain 1/1 AC";
        case UC_ADC_CH2_OFFSET_1_1_AC:
            return "ADC Ch2 Offset 1/1 AC";

        case UC_ADC_CH1_GAIN_1_20_AC:
            return "ADC Ch1 Gain 1/20 AC";
        case UC_ADC_CH1_OFFSET_1_20_AC:
            return "ADC Ch1 Offset 1/20 AC";
        case UC_ADC_CH2_GAIN_1_20_AC:
            return "ADC Ch2 Gain 1/20 AC";
        case UC_ADC_CH2_OFFSET_1_20_AC:
            return "ADC Ch2 Offset 1/20 AC";

        case UC_ADC_CH1_AA_1_1:
            return "ADC Ch1 AA 1/1";
        case UC_ADC_CH1_BB_1_1:
            return "ADC Ch1 BB 1/1";
        case UC_ADC_CH1_PP_1_1:
            return "ADC Ch1 PP 1/1";
        case UC_ADC_CH1_KK_1_1:
            return "ADC Ch1 KK 1/1";

        case UC_ADC_CH2_AA_1_1:
            return "ADC Ch2 AA 1/1";
        case UC_ADC_CH2_BB_1_1:
            return "ADC Ch2 BB 1/1";
        case UC_ADC_CH2_PP_1_1:
            return "ADC Ch2 PP 1/1";
        case UC_ADC_CH2_KK_1_1:
            return "ADC Ch2 KK 1/1";

        case UC_ADC_CH3_AA_1_1:
            return "ADC Ch3 AA 1/1";
        case UC_ADC_CH3_BB_1_1:
            return "ADC Ch3 BB 1/1";
        case UC_ADC_CH3_PP_1_1:
            return "ADC Ch3 PP 1/1";
        case UC_ADC_CH3_KK_1_1:
            return "ADC Ch3 KK 1/1";

        case UC_ADC_CH4_AA_1_1:
            return "ADC Ch4 AA 1/1";
        case UC_ADC_CH4_BB_1_1:
            return "ADC Ch4 BB 1/1";
        case UC_ADC_CH4_PP_1_1:
            return "ADC Ch4 PP 1/1";
        case UC_ADC_CH4_KK_1_1:
            return "ADC Ch4 KK 1/1";

        case UC_ADC_CH1_AA_1_20:
            return "ADC Ch1 AA 1/20";
        case UC_ADC_CH1_BB_1_20:
            return "ADC Ch1 BB 1/20";
        case UC_ADC_CH1_PP_1_20:
            return "ADC Ch1 PP 1/20";
        case UC_ADC_CH1_KK_1_20:
            return "ADC Ch1 KK 1/20";

        case UC_ADC_CH2_AA_1_20:
            return "ADC Ch2 AA 1/20";
        case UC_ADC_CH2_BB_1_20:
            return "ADC Ch2 BB 1/20";
        case UC_ADC_CH2_PP_1_20:
            return "ADC Ch2 PP 1/20";
        case UC_ADC_CH2_KK_1_20:
            return "ADC Ch2 KK 1/20";

        case UC_ADC_CH3_AA_1_20:
            return "ADC Ch3 AA 1/20";
        case UC_ADC_CH3_BB_1_20:
            return "ADC Ch3 BB 1/20";
        case UC_ADC_CH3_PP_1_20:
            return "ADC Ch3 PP 1/20";
        case UC_ADC_CH3_KK_1_20:
            return "ADC Ch3 KK 1/20";

        case UC_ADC_CH4_AA_1_20:
            return "ADC Ch4 AA 1/20";
        case UC_ADC_CH4_BB_1_20:
            return "ADC Ch4 BB 1/20";
        case UC_ADC_CH4_PP_1_20:
            return "ADC Ch4 PP 1/20";
        case UC_ADC_CH4_KK_1_20:
            return "ADC Ch4 KK 1/20";

        case UC_DAC_CH1_GAIN_50Ohm:
            return "DAC Ch1 Gain (50Ohm)";
        case UC_DAC_CH1_OFFSET_50Ohm:
            return "DAC Ch1 Offset (50Ohm)";
        case UC_DAC_CH2_GAIN_50Ohm:
            return "DAC Ch2 Gain (50Ohm)";
        case UC_DAC_CH2_OFFSET_50Ohm:
            return "DAC Ch2 Offset (50Ohm)";
        case UC_DAC_CH1_GAIN_X5_50Ohm:
            return "DAC Ch1 Gain x5 (50Ohm)";
        case UC_DAC_CH1_OFFSET_X5_50Ohm:
            return "DAC Ch1 Offset x5 (50Ohm)";
        case UC_DAC_CH2_GAIN_X5_50Ohm:
            return "DAC Ch2 Gain x5 (50Ohm)";
        case UC_DAC_CH2_OFFSET_X5_50Ohm:
            return "DAC Ch2 Offset x5 (50Ohm)";
    }
    return "";
}
