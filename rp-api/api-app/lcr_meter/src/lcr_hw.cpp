...
const double G_SHUNT_TABLE[] = {10, 1e2, 1e3, 1e4, 1e5, 1.3e6};
...
auto CLCRHardware::isExtensionConnected(bool _muteWarnings) -> bool {
    checkExtensionModuleConnection(_muteWarnings);
    return is_connected;
}
...
auto CLCRHardware::checkExtensionModuleConnection(bool _muteWarnings) -> lcr_error_t {
    ...
    // Disable for 250-12 v1.0 and 1.1
