...
module red_pitaya_scope_Z20 #(
  parameter RSZ = 14  // RAM size 2^RSZ
   ...
   input      [ 16-1: 0] adc_a_i         ,  // ADC data CHA // JB 11/02/19
   input      [ 16-1: 0] adc_b_i         ,  // ADC data CHB // JB 11/02/19
   // trigger sources
...
wire [ 16-1: 0] adc_a_filt_out ;  // JB 11/02/19
//wire [ 14-1: 0] adc_b_filt_in  ;
//wire [ 14-1: 0] adc_b_filt_out ;
wire [ 16-1: 0] adc_b_filt_out ;  // JB 11/02/19
...
reg  [ 16-1: 0] adc_a_dat     ; // JB 11/02/19
reg  [ 16-1: 0] adc_b_dat     ; // JB 11/02/19
...
reg   [  16-1: 0] adc_a_buf [0:(1<<RSZ)-1] ;  // JB 11/02/19
reg   [  16-1: 0] adc_b_buf [0:(1<<RSZ)-1] ;  // JB 11/02/19
//reg   [  14-1: 0] adc_a_rd      ;
//reg   [  14-1: 0] adc_b_rd      ;
reg   [  16-1: 0] adc_a_rd      ; // JB 11/02/19
reg   [  16-1: 0] adc_b_rd      ; // JB 11/02/19
reg   [ RSZ-1: 0] adc_wp        ;
...
if (adc_rstn_i == 1'b0) begin
   ...
   casez (sys_addr[19:0])
     ...
     20'h1???? : begin sys_ack <= adc_rd_dv;       sys_rdata <= {16'h0, adc_a_rd}                   ; end  // JB 11/02/19
     20'h2???? : begin sys_ack <= adc_rd_dv;       sys_rdata <= {16'h0, adc_b_rd}                   ; end  // JB 11/02/19
