...
### SATA connector
set_property IOSTANDARD LVCMOS33 [get_ports {daisy_p_o[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {daisy_n_o[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {daisy_p_i[*]}]
set_property IOSTANDARD LVCMOS33 [get_ports {daisy_n_i[*]}]
