...
CONFIG.PCW_I2C0_PERIPHERAL_ENABLE {1} CONFIG.PCW_MIO_16_PULLUP {disabled} \
...
CONFIG.PCW_MIO_29_SLEW {fast} CONFIG.PCW_MIO_30_PULLUP {disabled} \
...
CONFIG.PCW_MIO_39_SLEW {fast} CONFIG.PCW_PRESET_BANK1_VOLTAGE {LVCMOS 2.5V} \
