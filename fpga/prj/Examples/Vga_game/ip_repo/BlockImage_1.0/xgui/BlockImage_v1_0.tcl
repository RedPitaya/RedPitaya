...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "RESET_SIZEY"
  ipgui::add_param $IPINST -name "RESET_POSX"
  ipgui::add_param $IPINST -name "RESET_POSY"
  ipgui::add_param $IPINST -name "RESET_SIZEX"
...
proc update_PARAM_VALUE.RESET_SIZEX { PARAM_VALUE.RESET_SIZEX } {
	# Procedure called to update RESET_SIZEX when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RESET_SIZEX { PARAM_VALUE.RESET_SIZEX } {
	# Procedure called to validate RESET_SIZEX
	return true
}

proc update_PARAM_VALUE.RESET_SIZEY { PARAM_VALUE.RESET_SIZEY } {
	# Procedure called to update RESET_SIZEY when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.RESET_SIZEY { PARAM_VALUE.RESET_SIZEY } {
	# Procedure called to validate RESET_SIZEY
	return true
}
...
proc update_MODELPARAM_VALUE.RESET_SIZEX { MODELPARAM_VALUE.RESET_SIZEX PARAM_VALUE.RESET_SIZEX } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RESET_SIZEX}] ${MODELPARAM_VALUE.RESET_SIZEX}
}

proc update_MODELPARAM_VALUE.RESET_SIZEY { MODELPARAM_VALUE.RESET_SIZEY PARAM_VALUE.RESET_SIZEY } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.RESET_SIZEY}] ${MODELPARAM_VALUE.RESET_SIZEY}
}
