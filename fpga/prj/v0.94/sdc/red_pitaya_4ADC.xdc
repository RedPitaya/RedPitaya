...
# ADC 1 data
set_property PACKAGE_PIN Y14     [get_ports {adc_dat_i[1][0]}]
set_property PACKAGE_PIN W13     [get_ports {adc_dat_i[1][1]}]
set_property PACKAGE_PIN V12     [get_ports {adc_dat_i[1][2]}]
set_property PACKAGE_PIN V13     [get_ports {adc_dat_i[1][3]}]
set_property PACKAGE_PIN T14     [get_ports {adc_dat_i[1][4]}]
set_property PACKAGE_PIN T15     [get_ports {adc_dat_i[1][5]}]
set_property PACKAGE_PIN V15     [get_ports {adc_dat_i[1][6]}]

# ADC 2 data
set_property PACKAGE_PIN T17     [get_ports {adc_dat_i[2][0]}]
set_property PACKAGE_PIN R16     [get_ports {adc_dat_i[2][1]}]
set_property PACKAGE_PIN R18     [get_ports {adc_dat_i[2][2]}]
set_property PACKAGE_PIN P16     [get_ports {adc_dat_i[2][3]}]
set_property PACKAGE_PIN P18     [get_ports {adc_dat_i[2][4]}]
set_property PACKAGE_PIN N17     [get_ports {adc_dat_i[2][5]}]
set_property PACKAGE_PIN R19     [get_ports {adc_dat_i[2][6]}]

# ADC 3 data
set_property PACKAGE_PIN T20     [get_ports {adc_dat_i[3][0]}]
set_property PACKAGE_PIN T19     [get_ports {adc_dat_i[3][1]}]
set_property PACKAGE_PIN U20     [get_ports {adc_dat_i[3][2]}]
set_property PACKAGE_PIN V20     [get_ports {adc_dat_i[3][3]}]
set_property PACKAGE_PIN W20     [get_ports {adc_dat_i[3][4]}]
set_property PACKAGE_PIN W19     [get_ports {adc_dat_i[3][5]}]
set_property PACKAGE_PIN Y19     [get_ports {adc_dat_i[3][6]}]
...
set_property PACKAGE_PIN N18           [get_ports {adc_clk_i[1][1]}]
set_property PACKAGE_PIN P19           [get_ports {adc_clk_i[1][0]}]
...
set_property PACKAGE_PIN N20 [get_ports {daisy_p_i[1]}]
set_property PACKAGE_PIN P20 [get_ports {daisy_n_i[1]}]
