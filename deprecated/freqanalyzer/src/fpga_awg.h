/**
 * @brief Red Pitaya Arbitrary Waveform Generator (AWG) FPGA controller C header.
 *
 * @Author Jure Menart <juremenart@gmail.com>
 *
 * This is C header file. It includes various defines, structure definitions and
 * function declarations for FPGA AWG module. Please visit:
...
/** @defgroup fpga_awg_h fpga_awg_h
 * @{
 */
