...
//    segment.AddProperties(root,"time_stamp_now",dataprop);
    ...
    {       
        ...
        segment.AddRaw(channel, (resolution == 8 ? TDMS::DataType::UnsignedInteger8 : TDMS::DataType::UnsignedInteger16), size_ch1 , buffer_ch1);
    }
    ...
    {       
        ...
        data.push_back(channel);
        segment.AddRaw(channel, (resolution == 8 ? TDMS::DataType::UnsignedInteger8 : TDMS::DataType::UnsignedInteger16), size_ch2 , buffer_ch2);
    }
