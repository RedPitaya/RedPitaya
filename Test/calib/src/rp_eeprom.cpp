...
const char* c_wpCalParDesc_v2[eCalParEnd_v2][20] = {
    {"OSC_CH1_HIGH"},       {"OSC_CH2_HIGH"},       {"OSC_CH3_HIGH"},        {"OSC_CH4_HIGH"},        {"OSC_CH1_LOW"},         {"OSC_CH2_LOW"},
    {"OSC_CH3_LOW"},        {"OSC_CH4_LOW"},        {"OSC_CH1_HIGH_OFFSET"}, {"OSC_CH1_HIGH_OFFSET"}, {"OSC_CH1_HIGH_OFFSET"}, {"OSC_CH1_HIGH_OFFSET"},
    {"OSC_CH1_LOW_OFFSET"}, {"OSC_CH1_LOW_OFFSET"}, {"OSC_CH1_LOW_OFFSET"},  {"OSC_CH1_LOW_OFFSET"},

    {"OSC_CH1_HIGH_AA"},    {"OSC_CH1_HIGH_BB"},    {"OSC_CH1_HIGH_PP"},     {"OSC_CH1_HIGH_KK"},     {"OSC_CH1_LOW_AA"},      {"OSC_CH1_LOW_BB"},
    {"OSC_CH1_LOW_PP"},     {"OSC_CH1_LOW_KK"},

    {"OSC_CH2_HIGH_AA"},    {"OSC_CH2_HIGH_BB"},    {"OSC_CH2_HIGH_PP"},     {"OSC_CH2_HIGH_KK"},     {"OSC_CH2_LOW_AA"},      {"OSC_CH2_LOW_BB"},
    {"OSC_CH2_LOW_PP"},     {"OSC_CH2_LOW_KK"},

    {"OSC_CH3_HIGH_AA"},    {"OSC_CH3_HIGH_BB"},    {"OSC_CH3_HIGH_PP"},     {"OSC_CH3_HIGH_KK"},     {"OSC_CH3_LOW_AA"},      {"OSC_CH3_LOW_BB"},
    {"OSC_CH3_LOW_PP"},     {"OSC_CH3_LOW_KK"},

    {"OSC_CH4_HIGH_AA"},    {"OSC_CH4_HIGH_BB"},    {"OSC_CH4_HIGH_PP"},     {"OSC_CH4_HIGH_KK"},     {"OSC_CH4_LOW_AA"},      {"OSC_CH4_LOW_BB"},
    {"OSC_CH4_LOW_PP"},     {"OSC_CH4_LOW_KK"}

};

const char* c_wpCalParDesc_v3[eCalParEnd_v3][20] = {
    {"GEN_CH1_G_1"},       {"GEN_CH2_G_1"},       {"GEN_CH1_OFF_1"},    {"GEN_CH2_OFF_1"},    {"GEN_CH1_G_5"},       {"GEN_CH2_G_5"},
    {"GEN_CH1_OFF_5"},     {"GEN_CH2_OFF_5"},     {"OSC_CH1_G_1_AC"},   {"OSC_CH2_G_1_AC"},   {"OSC_CH1_OFF_1_AC"},  {"OSC_CH2_OFF_1_AC"},
    {"OSC_CH1_G_1_DC"},    {"OSC_CH2_G_1_DC"},    {"OSC_CH1_OFF_1_DC"}, {"OSC_CH2_OFF_1_DC"}, {"OSC_CH1_G_20_AC"},   {"OSC_CH2_G_20_AC"},
    {"OSC_CH1_OFF_20_AC"}, {"OSC_CH2_OFF_20_AC"}, {"OSC_CH1_G_20_DC"},  {"OSC_CH2_G_20_DC"},  {"OSC_CH1_OFF_20_DC"}, {"OSC_CH2_OFF_20_DC"}};
            ...
            switch (model) {
                ...
                case STEM_122_16SDR_v1_1: {
                    fprintf(stdout, "%20d %20d %20d %20d %20d %20d %20d %20d %20d %20d %20d %20d\n", data->feCalPar[eCalPar_FE_CH1_DC_offs],
                            data->feCalPar[eCalPar_FE_CH2_DC_offs], data->feCalPar[eCalPar_FE_CH1_FS_G_LO], data->feCalPar[eCalPar_FE_CH2_FS_G_LO],
                            data->feCalPar[eCalPar_FE_CH1_DC_offs_HI], data->feCalPar[eCalPar_FE_CH2_DC_offs_HI], data->feCalPar[eCalPar_FE_CH1_FS_G_HI],
                            data->feCalPar[eCalPar_FE_CH2_FS_G_HI], data->feCalPar[eCalPar_BE_CH1_DC_offs], data->feCalPar[eCalPar_BE_CH2_DC_offs],
                            data->feCalPar[eCalPar_BE_CH1_FS], data->feCalPar[eCalPar_BE_CH2_FS]);
                    break;
                }
