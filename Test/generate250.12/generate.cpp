...
const double c_max_frequency = ADC_SAMPLE_RATE / 2.0;
...
void usage() {
    ...
    const char *format =
        "%s version %s-%s\n"
        "\n"
        "Usage: %s   channel amplitude frequency <gain> <type> <end frequency>\n"
        "\n"
