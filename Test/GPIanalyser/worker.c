/**
 * $Id: acquire.c 892 2013-12-17 12:16:18Z ales.bardorfer $
 *
 ...
 * This module is multi-threaded and is using synchronization with mutexes from 
 * POSIX thread library. For these topics please visit:
