...
void usage_125_14() {
    ...
    fprintf(stderr, format_125_14, g_argv0, VERSION_STR, REVISION_STR, g_argv0, g_max_amplitude, g_min_frequency, g_max_frequency, s.c_str(), g_min_frequency,
            g_max_frequency);
}
...
void usage_250_12() {
    ...
    fprintf(stderr, format_250_12, g_argv0, VERSION_STR, REVISION_STR, g_argv0, g_max_amplitude, g_min_frequency, g_max_frequency, s.c_str(), g_min_frequency,
            g_max_frequency);
}
